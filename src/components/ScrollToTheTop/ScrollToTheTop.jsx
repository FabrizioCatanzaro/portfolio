    ...
    return (
        ...
        {showButton && (
            <div className='BtnToTop' onClick={scrollUp} >
                <svg xmlns="http://www.w3.org/2000/svg" id='btn-scrollTop' class="icon icon-tabler icon-tabler-arrow-badge-up-filled" width="44" height="44" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
